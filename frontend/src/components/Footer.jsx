  ...
  return (
    <footer className="mt-20 pt-16 pb-8 border-t bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4 flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 text-sm">
        <div>
          <img src={assets.logo} className="mb-5 w-32" alt="Vedya Logo" />
          <p className="w-full md:w-2/3 text-gray-600 leading-relaxed">
            Welcome to Vedya. We craft high-quality fashion that empowers your individual style. Experience the perfect blend of modern aesthetics, comfort, and premium craftsmanship.
          </p>
        </div>
      ...
      <div>
        ...
        <p className="py-5 text-sm text-center text-gray-500">
          © {new Date().getFullYear()} Vedya - All Rights Reserved.
        </p>
      </div>
    </footer>
  );
