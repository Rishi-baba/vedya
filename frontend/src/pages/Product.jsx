    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>An e-commerce website built with React and Tailwind CSS.</p>
          <p>This website offers a seamless shopping experience with a variety of products to choose from. It features a user-friendly interface, responsive design, and smooth navigation.</p>
        </div>
      </div>
